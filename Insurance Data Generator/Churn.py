...
customer_names = [fake() for _ in range(num_records)]
...
churn_labels = np.random.choice([0, 1], num_records, p=[0.8, 0.2])
# churn_labels = None
...
data.to_csv('C:\WorkSpaces\CodeSpaces\DataGenerator\Insurance Data Generator\csv\Churn\insurance_dataset_training.csv', index=False)
