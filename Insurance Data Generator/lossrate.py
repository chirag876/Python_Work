...
# Generate loss rate labels
#loss_rates = np.random.uniform(0, 0.2, num_records)
loss_rates = None
...
data.to_csv('C:\WorkSpaces\CodeSpaces\DataGenerator\Insurance Data Generator\csv\Loss Rate\loss_rate_prediction_dataset_test.csv', index=False)
